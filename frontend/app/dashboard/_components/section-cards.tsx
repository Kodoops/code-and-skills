...
import {userGetDashboardStats} from "@/actions/auth/user";

export async function SectionCards() {

    const response = await userGetDashboardStats();

    if(!response || !response.data) return
        <CardError message={ response.message || "Erreur lors du chargement des informations."} title={"Erreur chargement des informations"}/>

    const {totalEnrollments, totalPathsEnrollments, totalCoursesEnrollments, totalWorkshopsEnrollments} = response.data;
