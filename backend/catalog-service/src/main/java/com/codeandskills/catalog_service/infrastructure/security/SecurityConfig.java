    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/catalog/public/**").permitAll()
                        .requestMatchers("/catalog/user/**").authenticated()
                        .requestMatchers("/catalog/premium/**").hasAnyAuthority("ROLE_PREMIUM", "ROLE_ADMIN")
                        .requestMatchers("/catalog/instructor/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_INSTRUCTOR")
