...
public class KafkaConfig {
    ...
    // =====================================================
    // 🟢 CONSUMER CONFIG  (ex: écoute des UserRegisteredEvent)
    // =====================================================
    @Bean
    ...
    // =====================================================
    // 🔵 PRODUCER CONFIG  (ex: publication de CourseCreatedEvent)
    // =====================================================
    @Bean
    ...
    // Si tu veux un KafkaTemplate typé pour les événements du catalog
    @Bean
