package com.codeandskills.notification_service.infrastructure.web.error;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleGeneric(Exception ex) {
        return buildResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Erreur interne du service Content", ex);
    }
...
//    }
    ...
    private ResponseEntity<Map<String, Object>> buildResponse(HttpStatus status, String message, Exception ex) {
        ...
        log.error("❌ [{}] {}: {}", status.value(), status.getReasonPhrase(), message);
