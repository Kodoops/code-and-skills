...
//        log.info("Gateway signature: userId={}, sessionId={}, signature={}", userId, sessionId, signature);
//
//        String path = request.getRequestURI();
//        if (path.startsWith("/billing/webhook")) {
//            log.info("Webhook: userId={}, sessionId={}, signature={}", userId, sessionId, signature);
